...
export class TableRepository {
  ...
  async createTable(data) {
    ...
    return this.prisma.cmsTable.create({
      data,
      include: {
        project: true,
        columns: true,
  ...
  async findTableById(tableId) {
    ...
    return this.prisma.cmsTable.findUnique({
      where: { id: tableId },
      include: {
        project: true,
        columns: true,
  ...
  async findTablesByProjectId(projectId) {
    ...
    return this.prisma.cmsTable.findMany({
      where: { projectId },
      include: {
        columns: true,
        rows: {
  ...
  async updateTable(tableId, data) {
    ...
    return this.prisma.cmsTable.update({
      where: { id: tableId },
      data,
      include: {
        project: true,
  ...
  async deleteTable(tableId) {
    ...
    return this.prisma.cmsTable.delete({
      where: { id: tableId },
    });
  }
